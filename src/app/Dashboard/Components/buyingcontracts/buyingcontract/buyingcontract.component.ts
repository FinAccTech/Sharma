...
@Component({
  ...
  styleUrls: ['./buyingcontract.component.scss'],  
}) 

@AutoUnsubscribe
export class BuyingcontractComponent implements OnInit {
  ...
  SelectedDoc: TypeDocHeader = {
    TransSno: 0,
    VouTypeSno: this.globals.VTypBuyingContract,
    Series: {SeriesSno:0, Series_Name: "", VouTypeSno: this.globals.VTypBuyingContract},
    Trans_No:"",
  ...
  ngOnInit(): void {    
    ...
    if (this.Transaction.TransSno === 0)
      ...
      this.SelectedDoc.VouTypeSno = this.globals.VTypBuyingContract;
  ...
  SaveTransaction(){       
    ...
    this.progressService.sendUpdate("start","Saving Buying Contract");
