...
import { JobworkerComponent } from './jobworker/jobworker.component';
import { AutoUnsubscribe } from 'src/app/auto-unsubscribe.decorator';

@AutoUnsubscribe
@Component({
  selector: 'app-jobworkers',
  templateUrl: './jobworkers.component.html',
  styleUrls: ['./jobworkers.component.scss']
})
export class JobworkersComponent {
  ...
  LoadPartiesList(){
    ...
    pty.getParties(0,this.globals.PartyTypJobWorkers).subscribe(  data => {                           
  ...
  OpenParty(pty: TypeParties){        
    const dialogRef = this.dialog.open(JobworkerComponent, 
      {
        width:"45vw",
        height:"100vh",
